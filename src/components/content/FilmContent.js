...
const ReadMore = ({ children }) => {
  ...
  return (
    <p className="readtext">
      {isReadMore ? text.slice(0, 178) : text}
    ...
    <div className="readcontainer">
      <h2>
        <ReadMore>
          ...
          them the content related to the movie. Our expertise covers all areas
          of marketing and promotion, including strategy, advertising, on Ground
          promotions and social media campaigns, TV, Radio, Hording, Influencer
          marketing and outdoor outreach.
        </ReadMore>
      </h2>
    </div>
  );
